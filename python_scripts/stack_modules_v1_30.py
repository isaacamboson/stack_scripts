	...
	try:
		...
		with open(fullpath_log, "r") as r:
			...
			if "successfully completed" in log_check:
				...
				print("Database export was NOT completed.")
...
#creating the function that enables or disables versioning on an s3 bucket
def aws_s3_enable_disable_versioning(**args):
    try:
		...
		#checking if the versioning was successfully applied to the s3 bucket
		...
		#using the 'get_bucket_versioning' method to verify the new versioning configuration for the s3 bucket
...
#creating the function that enables or disables bucket encryption
...
#creating the function that enables server logging access on any bucket
