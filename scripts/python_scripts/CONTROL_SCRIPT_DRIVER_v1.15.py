...
if __name__ == "__main__":
	...
	if count_args == 0:
		...
		if function == "database_backup":
			...
			inp_OP_ID = input("Please provide the Operation ID for this operation: ")
			inp_OP_NAME = input("Please provide the name of this operation: ")
			inp_OP_TYPE = input("Please provide the operation type: ")
			...
			sm.database_backup(runner=inp_runner, schema=inp_schema, directory1=inp_directory1, backup_base=inp_backup_base, OP_ID=inp_OP_ID, OP_NAME=inp_OP_NAME, OP_TYPE=inp_OP_TYPE, OP_STATUS=inp_OP_STATUS)
			...
			sm.disk_maintenance_check_on_prem(disk=inp_disk, thresh_sm=inp_thresh_sm, thresh_bg=inp_thresh_bg, schema=inp_schema, OP_ID=inp_OP_ID, OP_NAME=inp_OP_NAME, OP_TYPE=inp_OP_TYPE, OP_STATUS=inp_OP_STATUS)
			...
			sm.database_import(runner=inp_runner, schema=inp_schema, dmp_file=inp_dmp_file, directory1=inp_directory1, backup_base=inp_backup_base, OP_ID=inp_OP_ID, OP_NAME=inp_OP_NAME, OP_TYPE=inp_OP_TYPE, OP_STATUS=inp_OP_STATUS)		
			...
			#calling the database migration function
			sm.database_migration(runner=inp_runner, schema=inp_schema, directory1=inp_directory1, backup_base=inp_backup_base, OP_ID=inp_OP_ID, OP_NAME=inp_OP_NAME, OP_TYPE=inp_OP_TYPE, OP_STATUS=inp_OP_STATUS)		
		...
		OP_NAME = sys.argv[7]
		OP_TYPE = sys.argv[8]
		OP_STATUS = sys.argv[9]		

		sm.database_backup(runner=sys.argv[2], schema=sys.argv[3], directory1=sys.argv[4], backup_base=sys.argv[5], OP_ID = sys.argv[6], OP_NAME = sys.argv[7], OP_TYPE = sys.argv[8], OP_STATUS = sys.argv[9])
	...
	elif sys.argv[1] == "disk_utilization" and count_args == 9:
		disk = sys.argv[2]
		...
		#calling the disk utilization function
		sm.disk_maintenance_check_on_prem(disk=sys.argv[2], thresh_sm=sys.argv[3], thresh_bg=sys.argv[4], runner = sys.argv[5], OP_ID = sys.argv[6], OP_NAME = sys.argv[7], OP_TYPE = sys.argv[8], OP_STATUS = sys.argv[9])
	...
	elif sys.argv[1] == "database_import" and count_args == 10:
		runner = sys.argv[2]
		schema = sys.argv[3]
		dmp_file = sys.argv[4]
		...
		OP_NAME = sys.argv[8]
		OP_TYPE = sys.argv[9]
		OP_STATUS = sys.argv[10]
				
		sm.database_import(runner=sys.argv[2], schema=sys.argv[3], dmp_file=sys.argv[4], directory1=sys.argv[5], backup_base=sys.argv[6], OP_ID = sys.argv[7], OP_NAME = sys.argv[8], OP_TYPE = sys.argv[9], OP_STATUS = sys.argv[10])
		...
		sm.database_migration(runner=sys.argv[2], schema=sys.argv[3], directory1=sys.argv[4], backup_base=sys.argv[5], OP_ID = sys.argv[6], OP_NAME = sys.argv[7], OP_TYPE = sys.argv[8], OP_STATUS = sys.argv[9])		
