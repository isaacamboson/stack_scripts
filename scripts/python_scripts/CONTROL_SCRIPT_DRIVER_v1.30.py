...
import os
import sys
import stack_modules_v1_30 as sm
import time
import datetime
import cx_Oracle
...
if __name__ == "__main__":
	...
	#performing a migration of users in a database to an AWS group		
	...
	#calling the aws function that lists the group(s) a user belongs to
	elif sys.argv[1] == "aws_list_groups_for_user" and count_args == 3:
		service = sys.argv[2]
		aws_user = sys.argv[3]
		sm.aws_list_groups_for_user(service = sys.argv[2], aws_user = sys.argv[3])


	#calling the aws function that deletes a user
	elif sys.argv[1] == "aws_delete_user" and count_args == 3:
		service = sys.argv[2]
		aws_user = sys.argv[3]
		sm.aws_delete_user(service = sys.argv[2], aws_user = sys.argv[3])


	#calling the aws function that removes a user from a group
	elif sys.argv[1] == "aws_remove_user_from_group" and count_args == 4:
		service = sys.argv[2]
		aws_user = sys.argv[3]
		group_name = sys.argv[4]
	...
	#calling the aws s3 empty bucket function
	elif sys.argv[1] == "aws_s3_empty_bucket" and count_args == 4:
		role_service = sys.argv[2]
		service = sys.argv[3]
		bucket_name = sys.argv[4]
		
		sm.aws_s3_empty_bucket(role_service = sys.argv[2], service = sys.argv[3], bucket_name = sys.argv[4])


	#rainy day scenario for calling the empty bucket function
	elif sys.argv[1] == "aws_s3_empty_bucket" and count_args != 4:
		print("You have provided the wrong number of command line arguments.")
		print("Please run this script in the format below:")
		print("python *scriptname* *role service* *service* *bucket name*")
	...
	#calling the aws s3 list_content bucket function
	elif sys.argv[1] == "aws_s3_list_content" and count_args == 4:
		role_service = sys.argv[2]
		service = sys.argv[3]
		bucket_name = sys.argv[4]
		
		sm.aws_s3_list_content(role_service = sys.argv[2], service = sys.argv[3], bucket_name = sys.argv[4])
	...
	#calling the aws s3 function that enables or disables versioning on an s3 bucket
	elif sys.argv[1] == "aws_s3_enable_disable_versioning" and count_args == 5:
		role_service = sys.argv[2]
		service = sys.argv[3]
		bucket_name = sys.argv[4]
		versioning_status = sys.argv[5]

		sm.aws_s3_enable_disable_versioning(role_service = sys.argv[2], service = sys.argv[3], bucket_name = sys.argv[4], versioning_status = sys.argv[5])
	...
	#rainy day scenario for calling the empty bucket function
		...
		print("You have provided the wrong number of command line arguments.")
		print("Please run this script in the format below:")
		print("python *scriptname* *role service* *service* *bucket name* *versioning status*")


	#calling the aws s3 function that enables or disables encryption on an s3 bucket
	elif sys.argv[1] == "aws_s3_bucket_encryption" and count_args == 5:
		role_service = sys.argv[2]
		service = sys.argv[3]
		bucket_name = sys.argv[4]
		encryption_action = sys.argv[5]

		sm.aws_s3_bucket_encryption(role_service = sys.argv[2], service = sys.argv[3], bucket_name = sys.argv[4], encryption_action = sys.argv[5])
	...
	#rainy day scenario for calling the empty bucket function
		...
		print("You have provided the wrong number of command line arguments.")
		print("Please run this script in the format below:")
		print("python *scriptname* *role service* *service* *bucket name* *encryption action*")


	#calling the aws s3 function that enables server access logging on an s3 bucket
	elif sys.argv[1] == "aws_s3_enable_server_access_logging" and count_args == 5:
		role_service = sys.argv[2]
		service = sys.argv[3]
		bucket_name = sys.argv[4]
		log_bucket = sys.argv[5]

		sm.aws_s3_enable_server_access_logging(role_service = sys.argv[2], service = sys.argv[3], bucket_name = sys.argv[4], log_bucket = sys.argv[5])
	...
	#rainy day scenario for calling the empty bucket function
		...
		print("You have provided the wrong number of command line arguments.")
		print("Please run this script in the format below:")
		print("python *scriptname* *role service* *service* *bucket name* *log_bucket*")


	#calling the aws s3 function that enables object level logging on an s3 bucket
	elif sys.argv[1] == "aws_s3_enable_obj_level_logging" and count_args == 7:
		role_service = sys.argv[2]
		s3_service = sys.argv[3]
		ct_service = sys.argv[4]
		bucket_name = sys.argv[5]
		trail_name = sys.argv[6]
		trail_prefix = sys.argv[7]

		sm.aws_s3_enable_obj_level_logging(role_service = sys.argv[2], s3_service = sys.argv[3], ct_service = sys.argv[4], bucket_name = sys.argv[5], trail_name = sys.argv[6], trail_prefix = sys.argv[7])
