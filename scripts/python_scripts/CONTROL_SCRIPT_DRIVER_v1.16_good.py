...
import os
import sys
import stack_modules_v1_16 as sm
import time
...
if __name__ == "__main__":
	...
	if count_args == 0:
		...
		sm.database_backup(runner=sys.argv[2], schema=sys.argv[3], directory1=sys.argv[4], backup_base=sys.argv[5], OP_NAME = sys.argv[6], OP_STATUS = sys.argv[7])
		...
		#calling the disk utilization function
		sm.disk_maintenance_check_on_prem(disk=sys.argv[2], thresh_sm=sys.argv[3], thresh_bg=sys.argv[4], runner = sys.argv[5], OP_NAME = sys.argv[6], OP_STATUS = sys.argv[7])
		...
		sm.database_import(runner=sys.argv[2], schema=sys.argv[3], dmp_file=sys.argv[4], directory1=sys.argv[5], backup_base=sys.argv[6], OP_NAME = sys.argv[7], OP_STATUS = sys.argv[8])
		...
		sm.database_migration(runner=sys.argv[2], schema=sys.argv[3], directory1=sys.argv[4], backup_base=sys.argv[5], OP_NAME = sys.argv[6], OP_STATUS = sys.argv[7])		
