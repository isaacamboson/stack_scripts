...
def db_connection(**db_conn):
	...
	if db_conn["STATUS"] == "BEGIN":
		...
		cursor.execute("""update operations set STATUS = :STATUS_INS where OP_ID = :OP_ID_INS""", STATUS_INS = STATUS, OP_ID_INS = db_conn["OP_ID"])
