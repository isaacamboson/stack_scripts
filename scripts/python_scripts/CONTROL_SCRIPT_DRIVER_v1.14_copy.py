...
import os
import sys
import stack_modules_v1_14_copy as sm
import time
...
if __name__ == "__main__":
	...
	elif sys.argv[1] == "disk_utilization" and count_args == 2:
		disk = sys.argv[2]

		#calling the disk utilization function
		sm.disk_maintenance_check_on_prem(disk)

	elif sys.argv[1] == "disk_utilization" and count_args != 2:
		print("You have provided the wrong number of command line arguments.")
		print("Please run this script in the format below:")
		print("python *scriptname* *function* *disk*")	
