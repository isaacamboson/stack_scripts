...
then
	...
	read -p "Please select 'backup', 'disk_utility_check', 'database_backup' or 'secure_copy': " ENTERED1
...
then
	...
	echo " "
	echo "USAGE: For secure copy, please enter 'secure_copy' only, and provide correct prompts."
	echo "Or enter 'secure_copy' followed by 5 command line arguments in following order: "
